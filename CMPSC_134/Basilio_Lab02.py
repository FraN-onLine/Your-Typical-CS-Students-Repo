# Retrieve word dictionary of Wordle
import urllib3 as url3
import random
import sys
import certifi

http = url3.PoolManager(cert_reqs='CERT_REQUIRED', ca_certs=certifi.where())

#http = url3.PoolManager()

resp = http.request("GET", "https://bit.ly/WordleValidWords")

validWords = str(resp.data)[2:].split("\\n") # List of all possible words that a player can input

resp = http.request("GET", "https://bit.ly/WordleWordPool")
